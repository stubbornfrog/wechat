...
import com.niuwajun.pojo.req.chatgpt.ChatGptReq;
...
public class CustomChatGpt {
     ...
     */
    private ChatGptReq chatGptRequestParameter = new ChatGptReq();
    ...
    public String getAnswer(CloseableHttpClient client, String question) {
        ...
        try {
            ...
            return client.execute(httpPost, response -> {
                ...
                // 转换为对象
                ChatGptResp responseParameter = objectMapper.readValue(resStr, ChatGptResp.class);
                String ans = "";
